...
All models trained using Caret were preprocessed with centering and scaling.
...
train_x_o <- train_x %>% left_join(train_outputs, by='run_id') %>% select(!c(run_id, response))
train_v_o <- train_v %>% left_join(train_outputs, by='run_id') %>% select(!c(run_id, response))
```
...
### mod_start_additive_all: All 5 starter inputs with additive features only
...
### mod_x_nnet_additive
```{r, eval=FALSE, include=TRUE}
mod_x_nnet_additive <- train(response ~ ., 
        data = train_x_r,
        method = 'nnet',
        metric = 'RMSE',
        preProcess = c("center", "scale"),
...
mod_x_nnet_additive %>% saveRDS(here("models", "mod_x_nnet_additive.Rds"))
```

### mod_x_ranger_additive

```{r, eval=FALSE, include=TRUE}
mod_x_ranger_additive <- train(response ~ ., 
        data = train_x_r,
        method = 'ranger',
        metric = 'RMSE',
        preProcess = c("center", "scale"),
...
mod_x_ranger_additive %>% saveRDS(here("models", "mod_x_ranger_additive.Rds"))
```


### mod_x_svmPoly_additive

```{r, eval=FALSE, include=TRUE}
mod_x_svmPoly_additive <- train(response ~ ., 
        data = train_x_r,
        method = 'svmPoly',
        metric = 'RMSE',
        preProcess = c("center", "scale"),
...
mod_x_svmPoly_additive %>% saveRDS(here("models", "mod_x_svmPoly_additive.Rds"))
```

### mod_x_kknn_additive

```{r, eval=FALSE, include=TRUE}
mod_x_kknn_additive <- train(response ~ ., 
        data = train_x_r,
        method = 'kknn',
        metric = 'RMSE',
        preProcess = c("center", "scale"),
...
mod_x_kknn_additive %>% saveRDS(here("models", "mod_x_kknn_additive.Rds"))
```


### mod_x_xgbTree_additive

```{r, eval=FALSE, include=TRUE}
mod_x_xgbTree_additive <- train(response ~ ., 
        data = train_x_r,
        method = 'xgbTree',
        metric = 'RMSE',
        preProcess = c("center", "scale"),
...
mod_x_xgbTree_additive %>% saveRDS(here("models", "mod_x_xgbTree_additive.Rds"))
```
...
```
Note to self: Do not, for the love of God, run this again. It took several hours.
...
### mod_v_nnet_additive_RMSE
```{r, eval=FALSE, include=TRUE}
mod_v_nnet_additive <- train(response ~ ., 
        data = train_v_r,
        method = 'nnet',
        metric = 'RMSE',
        preProcess = c("center", "scale"),
...
mod_v_nnet_additive %>% saveRDS(here("models", "mod_v_nnet_additive_RMSE.Rds"))
```

### mod_v_ranger_additive_RMSE

```{r, eval=FALSE, include=TRUE}
mod_v_ranger_additive <- train(response ~ ., 
        data = train_v_r,
        method = 'ranger',
        metric = 'RMSE',
        preProcess = c("center", "scale"),
...
mod_v_ranger_additive %>% saveRDS(here("models", "mod_v_ranger_additive_RMSE.Rds"))
```


### mod_v_svmPoly_additive_RMSE

```{r, eval=FALSE, include=TRUE}
mod_v_svmPoly_additive <- train(response ~ ., 
        data = train_v_r,
        method = 'svmPoly',
        metric = 'RMSE',
        preProcess = c("center", "scale"),
...
mod_v_svmPoly_additive %>% saveRDS(here("models", "mod_v_svmPoly_additive_RMSE.Rds"))
```

### mod_v_kknn_additive_RMSE

```{r, eval=FALSE, include=TRUE}
mod_v_kknn_additive <- train(response ~ ., 
        data = train_v_r,
        method = 'kknn',
        metric = 'RMSE',
        preProcess = c("center", "scale"),
...
mod_v_kknn_additive %>% saveRDS(here("models", "mod_v_kknn_additive_RMSE.Rds"))
```


### mod_v_xgbTree_additive_RMSE

```{r, eval=FALSE, include=TRUE}
mod_v_xgbTree_additive <- train(response ~ ., 
        data = train_v_r,
        method = 'xgbTree',
        metric = 'RMSE',
        preProcess = c("center", "scale"),
...
mod_v_xgbTree_additive %>% saveRDS(here("models", "mod_v_xgbTree_additive_RMSE.Rds"))
```
...
### mod_x_nnet_additive_Accuracy
```{r, eval=FALSE, include=TRUE}
mod_x_nnet_additive <- train(outcome ~ ., 
        data = train_x_o,
        method = 'nnet',
        metric = 'Accuracy',
        preProcess = c("center", "scale"),
...
mod_x_nnet_additive %>% saveRDS(here("models", "mod_x_nnet_additive_Accuracy.Rds"))
```

### mod_x_ranger_additive_Accuracy

```{r, eval=FALSE, include=TRUE}
mod_x_ranger_additive <- train(outcome ~ ., 
        data = train_x_o,
        method = 'ranger',
        metric = 'Accuracy',
        preProcess = c("center", "scale"),
...
mod_x_ranger_additive %>% saveRDS(here("models", "mod_x_ranger_additive_Accuracy.Rds"))
```


### mod_x_svmPoly_additive_Accuracy

```{r, eval=FALSE, include=TRUE}
mod_x_svmPoly_additive <- train(outcome ~ ., 
        data = train_x_o,
        method = 'svmPoly',
        metric = 'Accuracy',
        preProcess = c("center", "scale"),
...
mod_x_svmPoly_additive %>% saveRDS(here("models", "mod_x_svmPoly_additive_Accuracy.Rds"))
```

### mod_x_kknn_additive_Accuracy

```{r, eval=FALSE, include=TRUE}
mod_x_kknn_additive <- train(outcome ~ ., 
        data = train_x_o,
        method = 'kknn',
        metric = 'Accuracy',
        preProcess = c("center", "scale"),
...
mod_x_kknn_additive %>% saveRDS(here("models", "mod_x_kknn_additive_Accuracy.Rds"))
```


### mod_x_xgbTree_additive_Accuracy

```{r, eval=FALSE, include=TRUE}
mod_x_xgbTree_additive <- train(outcome ~ ., 
        data = train_x_o,
        method = 'xgbTree',
        metric = 'Accuracy',
        preProcess = c("center", "scale"),
...
mod_x_xgbTree_additive %>% saveRDS(here("models", "mod_x_xgbTree_additive_Accuracy.Rds"))
```

### mod_x_nnet_additive_ROC
```{r, eval=FALSE, include=TRUE}
mod_x_nnet_additive <- train(outcome ~ ., 
        data = train_x_o,
        method = 'nnet',
...
mod_x_nnet_additive %>% saveRDS(here("models", "mod_x_nnet_additive_ROC.Rds"))
```

### mod_x_ranger_additive_ROC
...
mod_x_ranger_additive %>% saveRDS(here("models", "mod_x_ranger_additive_ROC.Rds"))
```


### mod_x_svmPoly_additive_ROC
...
mod_x_svmPoly_additive %>% saveRDS(here("models", "mod_x_svmPoly_additive_ROC.Rds"))
```

### mod_x_kknn_additive_ROC
...
mod_x_kknn_additive %>% saveRDS(here("models", "mod_x_kknn_additive_ROC.Rds"))
```


### mod_x_xgbTree_additive_ROC
...
mod_x_xgbTree_additive %>% saveRDS(here("models", "mod_x_xgbTree_additive_ROC.Rds"))
```
...
m %>% saveRDS(here("models", "mod_v_glmnet_pairwise_all_b.Rds"))
proc.time() - ptm
```
...
### mod_v_nnet_additive_Accuracy
```{r, eval=FALSE, include=TRUE}
mod_v_nnet_additive <- train(outcome ~ ., 
        data = train_v_o,
        method = 'nnet',
        metric = 'Accuracy',
        preProcess = c("center", "scale"),
...
mod_v_nnet_additive %>% saveRDS(here("models", "mod_v_nnet_additive_Accuracy.Rds"))
```

### mod_v_ranger_additive_Accuracy

```{r, eval=FALSE, include=TRUE}
mod_v_ranger_additive <- train(outcome ~ ., 
        data = train_v_o,
        method = 'ranger',
        metric = 'Accuracy',
        preProcess = c("center", "scale"),
...
mod_v_ranger_additive %>% saveRDS(here("models", "mod_v_ranger_additive_Accuracy.Rds"))
```


### mod_v_svmPoly_additive_Accuracy

```{r, eval=FALSE, include=TRUE}
mod_v_svmPoly_additive <- train(outcome ~ ., 
        data = train_v_o,
        method = 'svmPoly',
        metric = 'Accuracy',
        preProcess = c("center", "scale"),
...
mod_v_svmPoly_additive %>% saveRDS(here("models", "mod_v_svmPoly_additive_Accuracy.Rds"))
```

### mod_v_kknn_additive_Accuracy

```{r, eval=FALSE, include=TRUE}
mod_v_kknn_additive <- train(outcome ~ ., 
        data = train_v_o,
        method = 'kknn',
        metric = 'Accuracy',
        preProcess = c("center", "scale"),
...
mod_v_kknn_additive %>% saveRDS(here("models", "mod_v_kknn_additive_Accuracy.Rds"))
```


### mod_v_xgbTree_additive_Accuracy

```{r, eval=FALSE, include=TRUE}
mod_v_xgbTree_additive <- train(outcome ~ ., 
        data = train_v_o,
        method = 'xgbTree',
        metric = 'Accuracy',
        preProcess = c("center", "scale"),
...
mod_v_xgbTree_additive %>% saveRDS(here("models", "mod_v_xgbTree_additive_Accuracy.Rds"))
```

### mod_v_nnet_additive_ROC
```{r, eval=FALSE, include=TRUE}
mod_v_nnet_additive <- train(outcome ~ ., 
        data = train_v_o,
        method = 'nnet',
...
mod_v_nnet_additive %>% saveRDS(here("models", "mod_v_nnet_additive_ROC.Rds"))
```

### mod_v_ranger_additive_ROC
...
mod_v_ranger_additive %>% saveRDS(here("models", "mod_v_ranger_additive_ROC.Rds"))
```


### mod_v_svmPoly_additive_ROC
...
mod_v_svmPoly_additive %>% saveRDS(here("models", "mod_v_svmPoly_additive_ROC.Rds"))
```

### mod_v_kknn_additive_ROC
...
mod_v_kknn_additive %>% saveRDS(here("models", "mod_v_kknn_additive_ROC.Rds"))
```


### mod_v_xgbTree_additive_ROC
...
mod_v_xgbTree_additive %>% saveRDS(here("models", "mod_v_xgbTree_additive_ROC.Rds"))
```